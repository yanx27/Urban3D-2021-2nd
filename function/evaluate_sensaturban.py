"""
Evaluating script for scene segmentation with SensatUrban dataset
"""
import os
import sys
import time
...
from utils.metrics import SensatUrban_metrics, SensatUrban_subset_metrics, SensatUrban_voting_metrics


def parse_option():
    parser = argparse.ArgumentParser("Evaluating SensatUrban")
...
if __name__ == "__main__":
    ...
    logger = setup_logger(output=config.log_dir, name="SensatUrban_eval")
